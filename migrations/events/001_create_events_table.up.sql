...
CREATE INDEX IF NOT EXISTS aggregate_id_aggregate_type_version_idx on microservices.events USING btree(aggregate_id, aggregate_type, version ASC);
...
CREATE INDEX IF NOT EXISTS aggregate_id_aggregate_type_version_idx ON microservices.snapshots USING btree (aggregate_id, aggregate_type, version);
